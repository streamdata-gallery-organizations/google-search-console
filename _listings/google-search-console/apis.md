...
- name: Google URL Testing Tools API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-search-console/master/_listings/google-search-console/v1-urltestingtools-mobilefriendlytest-run-post.md
x-common:
- type: x-blog
